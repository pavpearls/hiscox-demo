...
export class EventsTableComponent implements OnInit {
  ...
  private transformEventDataItem(event: Event): any {
    return {
      ...
      eventTypeName: event.eventType?.eventTypeName || '<No Data>',
      eventNameShort: event.eventNameShort || '<No Data>',
      regionPerilName: event.regionPeril?.regionPerilName || '<No Data>',
      userName: event.createUser?.userName || '<No Data>',
      ...
      hiscoxLossImpactRating: event.hiscoxLossImpactRating || '<No Data>',
